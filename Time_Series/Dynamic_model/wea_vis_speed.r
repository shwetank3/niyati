...
for(i in 1:96){
  ...
  coeff.speed<- cbind(speed.reg.ts.filt$a[,1],speed.reg.ts.filt$a[,2],speed.reg.ts.filt$a[,3],speed.reg.ts.filt$a[,4],speed.reg.ts.filt$a[,5],speed.reg.ts.filt$a[,6],speed.reg.ts.filt$a[,7])
  pred.coeff <- coeff.speed[2591+i,]
  pred.reg.vec <- cbind(1,wea[2592+i,1],wea[2592+i,2],wea[2592+i,3],visibility[2592+i],speed_29[2591+i],speed_31[2591+i])
